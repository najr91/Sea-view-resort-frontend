  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        <h1 className="text-white text-4xl md:text-5xl font-serif mb-4">Contacto</h1>
        <p className="max-w-2xl mx-auto text-resort-cream/90 text-sm md:text-base leading-relaxed">
          Estamos a su disposición para asistirlo. Escríbanos y nuestro equipo se pondrá en contacto a la brevedad.
        </p>
      </div>
    </section>
  );
